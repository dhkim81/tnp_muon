...
#    OutputFileName = cms.string("/afs/cern.ch/user/d/dhkim/eos/cms/store/user/dhkim/TnP_Muon_ID_Data_voigtPlusExpo.root"),
    OutputFileName = cms.string("../TnP_Muon_ID_Data_vpvPlusExpo_4.root"),
...
#    OutputFileName = cms.string("/afs/cern.ch/user/d/dhkim/eos/cms/store/user/dhkim/TnP_Muon_ID_Data_vpvPlusCheb.root"),
    ...
    Expressions = cms.PSet(
      Tight_var = cms.vstring( "Tight_var", "Tight2012==1 && tag_pt > 21 && abs(dB) < 0.2 && abs(dzPV) < 0.5", "Tight2012", "tag_pt", "dB", "dzPV"),
      ),
...
process.TnP_Muon_Iso = process.TnP_Muon_ID.clone(
    OutputFileName = cms.string("../TnP_Muon_Iso_Data_vpvPlusExpo_4.root"),
    ## More variables
    ...
    Expressions = cms.PSet(
      Tight_Iso_var = cms.vstring( "Tight_Iso_var", "tag_combRelIsoPF04dBeta < 0.15 && tag_pt > 20", "tag_combRelIsoPF04dBeta", "tag_pt"),
      ),
    ## Cuts: name, variable, cut threshold
    Cuts = cms.PSet(
