...
"root://eoscms//eos/cms/store/group/phys_muon/TagAndProbe/76XtreeProduction/v41/TnPTree_v41_76X_RunD_part4.root",
...
#    OutputFileName = cms.string("/afs/cern.ch/user/d/dhkim/eos/cms/store/user/dhkim/TnP_Muon_ID_Data_voigtPlusExpo.root"),
    OutputFileName = cms.string("../TnP_Muon_ID_Data_vpvPlusExpo_5_withJet0.root"),
...
#    OutputFileName = cms.string("/afs/cern.ch/user/d/dhkim/eos/cms/store/user/dhkim/TnP_Muon_ID_Data_vpvPlusCheb.root"),
    ...
    Expressions = cms.PSet(
      Tight_var = cms.vstring( "Tight_var", "Tight2012==1 && tag_pt > 21 && abs(dB) < 0.2 && abs(dzPV) < 0.5 && pair_nJets30 >= 0", "Tight2012", "tag_pt", "dB", "dzPV", "pair_nJets30"),
      ),
...
#	BinToPDFmap = cms.vstring("vpvPlusCheb"), ## PDF to use, as defined below
	...
	BinnedVariables = cms.PSet(
	  ...
	  #pt     = cms.vdouble( 20, 25, 30, 40, 50, 60),
...
process.TnP_Muon_Iso = process.TnP_Muon_ID.clone(
    OutputFileName = cms.string("../TnP_Muon_Iso_Data_vpvPlusExpo_5_withJet0.root"),
    ## More variables
    ...
    Expressions = cms.PSet(
      Tight_Iso_var = cms.vstring( "Tight_Iso_var", "tag_combRelIsoPF04dBeta < 0.15 && tag_pt > 20 && pair_nJets30 >= 0", "tag_combRelIsoPF04dBeta", "tag_pt", "pair_nJets30"),
      ),
    ## Cuts: name, variable, cut threshold
    Cuts = cms.PSet(
